...
public class MainMenuTileset extends Tileset {
    ...
    public ArrayList<MapTileBuilder> defineTiles() {
        ...
        Frame[] sunFrames = new Frame[]{
                new FrameBuilder(getSubImage(0, 3))
                        .withScale(tileScale)
                        .build(),
        };
        ...
        // right end branch
        Frame rightEndBranchFrame = new FrameBuilder(getSubImage(1, 0))
                .withScale(tileScale)
                .withBounds(0, 6, 16, 4)
        ...
        // right end branch
        Frame LeftUFrame = new FrameBuilder(getSubImage(1, 1))
                .withScale(tileScale)
                .withBounds(0, 6, 16, 4)
                .withImageEffect(ImageEffect.FLIP_HORIZONTAL)
                .build();

        MapTileBuilder LeftU = new MapTileBuilder(LeftUFrame)
                .withTileType(TileType.JUMP_THROUGH_PLATFORM);

        mapTiles.add(LeftU);
        // tree trunk
        Frame treeTrunkFrame = new FrameBuilder(getSubImage(1, 2))
                .withScale(tileScale)
                .build();
        ...
        Frame treeTrunkFrameA = new FrameBuilder(getSubImage(1, 3))
                .withScale(tileScale)
                .build();
        ...
        // tree top leaves
        Frame treeTopLeavesFrame = new FrameBuilder(getSubImage(1, 4))
                .withScale(tileScale)
                .build();
        ...
        // tree top leaves
        Frame treeTopLeavesFrameA = new FrameBuilder(getSubImage(1, 5))
                .withScale(tileScale)
                .build();
        ...
        // tree top leaves
        Frame treeTopLeavesFrameB = new FrameBuilder(getSubImage(2, 0))
                .withScale(tileScale)
                .build();
        ...
        // tree top leaves
        Frame treeTopLeavesFrameC = new FrameBuilder(getSubImage(2, 1))
                .withScale(tileScale)
                .build();
        ...
        mapTiles.add(treeTopLeavesTileC);


        Frame treeTopLeavesFrameD = new FrameBuilder(getSubImage(2, 2))
                .withScale(tileScale)
                .build();
        ...
        //hoverPlatformLeft
        Frame hoverPlatformLeftFrame = new FrameBuilder(getSubImage(3, 3))
                .withScale(tileScale)
                .build();
        ...
        //hoverPlatformMiddle
        Frame hoverPlatformMiddleFrame = new FrameBuilder(getSubImage(3, 4))
                .withScale(tileScale)
                .build();
        ...
        //hoverPlatformRight
        Frame hoverPlatformRightFrame = new FrameBuilder(getSubImage(3, 5))
                .withScale(tileScale)
                .build();
